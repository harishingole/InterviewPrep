...
public class Driver {
	public static void main(String[] args) {
		...
		employeeList.add(new Employee(133, "Martin Theron", 29, "Male", "Product Development", 2012, 18000.0));
...
//		System.out.println(emp);
		Employee emp = employeeList.stream().filter(a-> a.getDepartment().equals("Product Development"))
